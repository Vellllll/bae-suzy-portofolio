            ...
            <div class="col-lg-8">
                ...
                <div class="standard__blog__post">
                    ...
                    <div class="standard__blog__content">
                        ...
                        <h2 class="title"><a href="blog-details.html">{{ $blog->blog_title }}</a></h2>
            ...
            <div class="col-lg-4">
                <aside class="blog__sidebar">
                    ...
                    <div class="widget">
                        ...
                        <ul class="rc__post">
                            @foreach ($all_blogs as $recent_blog)
                            <li class="rc__post__item">
                                <div class="rc__post__thumb">
                                    <a href="blog-details.html"><img src="{{ asset($recent_blog->blog_image) }}" alt=""></a>
                                </div>
                                <div class="rc__post__content">
                                    <h5 class="title"><a href="blog-details.html">{{ $recent_blog->blog_title }}</a></h5>
                                    <span class="post-date"><i class="fal fa-calendar-alt"></i> {{ Carbon\Carbon::parse($recent_blog->created_at)->diffForHumans() }}</span>
                                </div>
                            </li>
                            @endforeach
                        </ul>
                    ...
                    <div class="widget">
                        ...
                        <ul class="sidebar__cat">
                            ...
                            <li class="sidebar__cat__item"><a href="{{ route('category.page', $category->id) }}">{{ $category->blog_category }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                    <div class="widget">
