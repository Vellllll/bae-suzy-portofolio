                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('update.blog', $blog->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-10">
                                    <select name="blog_category_id" class="form-select" aria-label="Default select example">
                                        @foreach ($blogcategories as $blogcategory)
                                            <option value="{{ $blogcategory->id }}" {{ $blogcategory->id == $blog->blog_category_id ? 'selected' : '' }} >{{ $blogcategory->blog_category }}</option>
                                        @endforeach
                                        </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="blog_tags" class="form-control" data-role="tagsinput" value="{{ $blog->blog_tags }}">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-3">
                                    <img id="showImage" class="card-img-top img-fluid" src="{{ asset($blog->blog_image) }}" alt="Card image cap">
                                </div>
                            </div>
